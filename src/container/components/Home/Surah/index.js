          ...
          <>
            <TouchableOpacity style={styles.surahList} key={item.number}
             onPress={() => navigate('InfoSurah', {
              ...
              <Text style={styles.surahListNumber}>{item.number}</Text>
              <View style={styles.surahData}>
                <Text style={styles.surahListName}>{item.englishName}</Text>
                <Text style={styles.surahListMean}>
